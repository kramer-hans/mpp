...
export const services: ServiceDef[] = [
  ...
  // ── Federal Grant Search API ──────────────────────────────────────────
  {
    ...
    url: "https://grant-search.krimskrams.xyz",
    serviceUrl: "https://grant-search.krimskrams.xyz",
    description:
      "Which current U.S. federal grants match my topic, agency, deadline, or award range, and what changed since my last check? Search stored Grants.gov records and a stored change feed.",
    categories: ["data", "search"],
    integration: "third-party",
    tags: ["grants", "government", "federal", "funding", "change-feed"],
    status: "active",
    docs: {
      homepage: "https://grant-search.krimskrams.xyz",
      llmsTxt: "https://grant-search.krimskrams.xyz/llms.txt",
      apiReference: "https://grant-search.krimskrams.xyz/openapi.json",
    },
    provider: { name: "Krimskrams", url: "https://krimskrams.xyz" },
    realm: "grant-search.krimskrams.xyz",
    intent: "charge",
    payments: [TEMPO_PAYMENT],
    endpoints: [
      {
        route: "GET /mpp/v1/search",
        desc: "Search current U.S. federal grant opportunities by topic, agency, status, deadline, or award range",
        amount: "20000",
        unitType: "request",
      },
      {
        route: "POST /mpp/v1/scan",
        desc: "Run and deduplicate up to 10 U.S. federal grant searches",
        amount: "120000",
        unitType: "request",
      },
      {
        route: "POST /mpp/v1/change-intelligence",
        desc: "Find stored U.S. federal grants that are new or changed since a prior check",
        amount: "20000",
        unitType: "request",
      },
      {
        route: "GET /mpp/v1/snapshot/:slice_id",
        desc: "Get a bounded snapshot of stored U.S. federal grant records",
        amount: "1000000",
        unitType: "request",
      },
    ],
  ...
  // ── FCC License Search API ────────────────────────────────────────────
  {
    ...
    url: "https://fcc-license-search.krimskrams.xyz",
    serviceUrl: "https://fcc-license-search.krimskrams.xyz",
    description:
      "Which FCC radio licenses belong to this company, call sign, or FRN? Get status, dates, source files, and ingest dates for stored FCC ULS records.",
    categories: ["data", "search"],
    integration: "third-party",
    tags: ["fcc", "licenses", "radio", "compliance", "provenance"],
    status: "active",
    docs: {
      homepage: "https://fcc-license-search.krimskrams.xyz",
      llmsTxt: "https://fcc-license-search.krimskrams.xyz/llms.txt",
      apiReference: "https://fcc-license-search.krimskrams.xyz/openapi.json",
    },
    provider: { name: "Krimskrams", url: "https://krimskrams.xyz" },
    realm: "fcc-license-search.krimskrams.xyz",
    intent: "charge",
    payments: [TEMPO_PAYMENT],
    endpoints: [
      {
        route: "GET /mpp/v1/search",
        desc: "Search stored FCC radio licenses by company name, call sign, or FRN with source provenance",
        amount: "20000",
        unitType: "request",
      },
      {
        route: "GET /mpp/v1/company",
        desc: "Get stored FCC radio licenses for one company with dates, status, and source provenance",
        amount: "100000",
        unitType: "request",
      },
      {
        route: "GET /mpp/v1/changes",
        desc: "Get stored FCC license status changes for an FRN, call sign, or radio service",
        amount: "50000",
        unitType: "request",
      },
      {
        route: "GET /mpp/v1/snapshot/:slice_id",
        desc: "Get a bounded snapshot of stored FCC license records",
        amount: "1000000",
        unitType: "request",
      },
    ],
  ...
  // ── Bounty Signals API ────────────────────────────────────────────────
  {
    ...
    url: "https://bounty-signals.krimskrams.xyz",
    serviceUrl: "https://bounty-signals.krimskrams.xyz",
    description:
      "Was a stored BountyBook or Taskmarket award actually paid? Get settlement evidence plus observed job history from BountyBook, Taskmarket, and Superteam.",
    categories: ["data", "search"],
    integration: "third-party",
    tags: ["bounties", "awards", "settlement", "payments", "job-history"],
    status: "active",
    docs: {
      homepage: "https://bounty-signals.krimskrams.xyz",
      llmsTxt: "https://bounty-signals.krimskrams.xyz/llms.txt",
      apiReference: "https://bounty-signals.krimskrams.xyz/openapi.json",
    },
    provider: { name: "Krimskrams", url: "https://krimskrams.xyz" },
    realm: "bounty-signals.krimskrams.xyz",
    intent: "charge",
    payments: [TEMPO_PAYMENT],
    endpoints: [
      {
        route: "GET /mpp/v1/wallet-wins",
        desc: "Get observed BountyBook and Taskmarket awards for an EVM wallet with available payout evidence",
        amount: "20000",
        unitType: "request",
      },
      {
        route: "GET /mpp/v1/boards/:slug/bounties",
        desc: "Get stored job history for BountyBook, Taskmarket, or Superteam",
        amount: "20000",
        unitType: "request",
      },
      {
        route: "GET /mpp/v1/funded-work/delta",
        desc: "Get newly open funded-work listings across BountyBook, Taskmarket, and Superteam without inferring escrow funding",
        amount: "20000",
        unitType: "request",
      },
      {
        route: "GET /mpp/v1/award-settlement",
        desc: "Check whether a stored BountyBook or Taskmarket award has payout evidence and return Base settlement proof when available",
        amount: "20000",
        unitType: "request",
      },
    ],
